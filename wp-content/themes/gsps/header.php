...
<body <?php body_class('antialiased'); ?> x-data="{ isOpen : false, atTop: true}" x-on:scroll.window="atTop = (window.pageYOffset > 100) ? false : true; ">
...
<div id="page" class="site">
	...
	<div class="mobile-navbar">         
		...
		<!-- navbar wrapper -->
		<div class="navbar-wrapper fixed top-0 left-0 h-full bg-white z-50 w-64 shadow-lg p-5" 
			x-show="isOpen" 
