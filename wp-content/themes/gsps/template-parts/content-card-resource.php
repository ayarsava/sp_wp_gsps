...
?>
<!-- BEG RESOURCE CARD -->
<div class="resource-item col-span-3 md:col-span-1 min-h-full h-80 relative bg-teal-light bg-no-repeat bg-left-top bg-cover relative
    <?php 
    if ( $featured_image ){ 
    ...
    if ( $featured_image ) { 
        ...
        the_title( '<h4 class="text-lg lg:text-xl font-semibold text-white hover:text-gray-800 leading-tight"><a href="'.esc_url( get_permalink() ).'" class="block group">', '</a></h4>' );
    }
