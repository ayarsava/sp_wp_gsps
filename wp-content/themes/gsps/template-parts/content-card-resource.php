...
?>
<!-- BEG RESOURCE CARD -->
<div data-aos="zoom-out-up" data-aos-delay="" class="resource-item col-span-3 md:col-span-1 h-64 relative bg-gray-100 bg-no-repeat bg-left-top bg-cover relative
    <?php 
    if ( $featured_image ){ 
