...
<!-- BEG QUOTE CARD--><div class="bg-yellow p-7 pt-5 relative">
	...
	<?php 
		the_title( '<blockquote class="md:absolute top-7 left-7 right-7 italic font-semibold text-lg leading-snug z-10">', '</blockquote>' );
	?>
	<div class="absolute bottom-4 left-4 right-7 text-xs text-right leading-tight text-gray-800">
	<?php
		the_content();
	?>
	</div>
